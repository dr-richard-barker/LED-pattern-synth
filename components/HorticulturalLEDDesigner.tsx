...
const HorticulturalLEDDesigner: React.FC = () => {
  ...
  const loadRecipe = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleExportCode = async () => {
      // Google GenAI-based C++/README export removed for standalone static deployment.
      alert("AI-assisted C++/README code export is disabled in this standalone build (it required a Gemini API key). The visual designer, pattern libraries and video export all work offline.");
    };

    const handleGenerateRecipe = async () => {
      // Google GenAI-based recipe generation removed for standalone static deployment.
      alert("The AI recipe generator is disabled in this standalone build (it required a Gemini API key). Use the pattern libraries and manual spectrum controls to build recipes.");
    };
